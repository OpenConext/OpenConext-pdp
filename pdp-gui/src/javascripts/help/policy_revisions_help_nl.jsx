        ...
        return (
            <div className="form-element about">
                ...
                <p>Elke keer als een autorisatieregel wordt bijgewerkt, wordt er een kopie van de
                    ...
                    met elkaar en met meest actuele regel te vergelijken kan een audit log worden getoond van alle
                    veranderingen
                ...
                <p>Wanneer een autorisatieregel wordt verwijderd dan worden ook alle revisies van die regel
                    verwijderd.</p>
            </div>
        );
    }
