    ...
    render() {
        return (
            <div className="form-element about">
                ...
                <p>Om de gevolgen van de autorisatieregels te testen kunt u een gebruiker van een bepaalde IdP
                    impersoneren.
                ...
                <ul>
                    ...
                    <li>Daarnaast is verwijderen en updaten van een policy verder beperkt:
                        <ul>
                            <li>de IdP van de gebruiker die de policy heeft gemaakt, moet de IDP van de gebruiker zijn
                                die de policy wil verwijderen of bijwerken
                            </li>
                        </ul>
                    </li>
                    <li>Policy&quot;s kunnen in alleen-lezenmodus bekeken worden als:
                        <ul>
                            <li>De verzameling IdP&quot;s van de policy leeg is en de SP van de policy toegang openstelt
                                voor &eacute;&eactute;n van de IdP&quot;s van de gebruiker, OF
                            </li>
                            <li>E&eacute;n van de IdP&quot;s van de policy de IdP van de gebruiker is, OF</li>
                            <li>De SP van de policy verbonden is met &eacute;&eacute;n van de IdP&quot;s van de
                                gebruiker.
                            </li>
                        </ul>
                    </li>
                    ...
                    <ul>
                        <ul>
                            <li>De IdP in het JSON-verzoek van de overtreding gelijk is aan één van de IdP&quot;s van de
                                gebruiker
                            </li>
                        </ul>
                    </ul>
