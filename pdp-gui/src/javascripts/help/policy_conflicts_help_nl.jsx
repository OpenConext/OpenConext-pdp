  ...
  render() {
    return (
        <div className="form-element about">
          ...
          <p>Als twee of meer autorisatieregels voor dezelfde service provider zijn geconfigureerd en er zijn ofwel geen
            Instellingen ofwel overlappende Instellingen geconfigureerd dan beschouwen we deze autorisatieregels als
            conflicterend.</p>
