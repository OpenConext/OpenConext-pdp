    ...
    render() {
        return (
            <div className="form-element about">
                <h1>Wat zijn geweigerde logins?</h1>

                <p>Elke keer als er een negatief besluit vanuit de Policy Decision Point (PDP) naar het Policy
                    Enforcement
                ...
                <p>Alle negatieve besluiten gemaakt door de PDP worden opgeslagen. Klik op het oog-pictogram als je de
                    details van een geweigerde login wilt bekijken.</p>

                <p>Voor elke geweigerde login worden de volgende gegevens bewaard (gedurende 30 dagen):</p>
                <ul>
