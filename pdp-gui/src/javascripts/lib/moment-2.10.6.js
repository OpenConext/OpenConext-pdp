(function(global, factory) {
  ...
  const formattingTokens = /(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|Q|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,9}|x|X|zz?|ZZ?|.)/g;
  ...
  function dayOfYearFromWeeks(year, week, weekday, firstDayOfWeekOfYear, firstDayOfWeek) {
    let week1Jan = 6 + firstDayOfWeek - firstDayOfWeekOfYear, janX = createUTCDate(year, 0, 1 + week1Jan), d = janX.getUTCDay(), dayOfYear;
    if (d < firstDayOfWeek) {
      d += 7;
    }
  ...
  const duration_get__months       = makeGetter("months");
  ...
  const _moment__default = utils_hooks__hooks;

  //! moment.js locale configuration
  //! locale : afrikaans (af)
  //! author : Werner Mollentze : https://github.com/wernerm

  const af = _moment__default.defineLocale("af", {
  ...
  const ar_ma = _moment__default.defineLocale("ar-ma", {
  ...
  const ar_sa = _moment__default.defineLocale("ar-sa", {
  ...
  const ar_tn = _moment__default.defineLocale("ar-tn", {
  ...
  const ar = _moment__default.defineLocale("ar", {
    months : ar__months,
  ...
  const az = _moment__default.defineLocale("az", {
  ...
  const be = _moment__default.defineLocale("be", {
  ...
  const bg = _moment__default.defineLocale("bg", {
  ...
  const bn = _moment__default.defineLocale("bn", {
  ...
  const bo = _moment__default.defineLocale("bo", {
  ...
  const br = _moment__default.defineLocale("br", {
  ...
  const bs = _moment__default.defineLocale("bs", {
  ...
  const ca = _moment__default.defineLocale("ca", {
  ...
  let cs__months = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_"),
  ...
  const cs = _moment__default.defineLocale("cs", {
    months : cs__months,
  ...
  const cv = _moment__default.defineLocale("cv", {
  ...
  const cy = _moment__default.defineLocale("cy", {
  ...
  const da = _moment__default.defineLocale("da", {
  ...
  const de_at = _moment__default.defineLocale("de-at", {
  ...
  const de = _moment__default.defineLocale("de", {
  ...
  const el = _moment__default.defineLocale("el", {
  ...
  const en_au = _moment__default.defineLocale("en-au", {
  ...
  const en_ca = _moment__default.defineLocale("en-ca", {
    months : "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
    monthsShort : "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
    weekdays : "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
    weekdaysShort : "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),
  ...
  const en_gb = _moment__default.defineLocale("en-gb", {
    months : "January_February_March_April_May_June_July_August_September_October_November_December".split("_"),
    monthsShort : "Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec".split("_"),
    weekdays : "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"),
    weekdaysShort : "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"),
  ...
  const eo = _moment__default.defineLocale("eo", {
  ...
  const es = _moment__default.defineLocale("es", {
  ...
  const et = _moment__default.defineLocale("et", {
  ...
  const eu = _moment__default.defineLocale("eu", {
  ...
  const fa = _moment__default.defineLocale("fa", {
  ...
  const fi = _moment__default.defineLocale("fi", {
  ...
  const fo = _moment__default.defineLocale("fo", {
  ...
  const fr_ca = _moment__default.defineLocale("fr-ca", {
  ...
  const fr = _moment__default.defineLocale("fr", {
    months : "janvier_février_mars_avril_mai_juin_juillet_août_septembre_octobre_novembre_décembre".split("_"),
    monthsShort : "janv._févr._mars_avr._mai_juin_juil._août_sept._oct._nov._déc.".split("_"),
    weekdays : "dimanche_lundi_mardi_mercredi_jeudi_vendredi_samedi".split("_"),
    weekdaysShort : "dim._lun._mar._mer._jeu._ven._sam.".split("_"),
  ...
  let fy__monthsShortWithDots = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"),
    fy__monthsShortWithoutDots = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_");

  const fy = _moment__default.defineLocale("fy", {
  ...
  const gl = _moment__default.defineLocale("gl", {
  ...
  const he = _moment__default.defineLocale("he", {
  ...
  const hi = _moment__default.defineLocale("hi", {
  ...
  const hr = _moment__default.defineLocale("hr", {
  ...
  const hu = _moment__default.defineLocale("hu", {
  ...
  function hy_am__monthsShortCaseReplace(m, format) {
    const monthsShort = "հնվ_փտր_մրտ_ապր_մյս_հնս_հլս_օգս_սպտ_հկտ_նմբ_դկտ".split("_");
    return monthsShort[m.month()];
  }
  function hy_am__weekdaysCaseReplace(m, format) {
    const weekdays = "կիրակի_երկուշաբթի_երեքշաբթի_չորեքշաբթի_հինգշաբթի_ուրբաթ_շաբաթ".split("_");
    return weekdays[m.day()];
  }

  const hy_am = _moment__default.defineLocale("hy-am", {
  ...
  const id = _moment__default.defineLocale("id", {
  ...
  const is = _moment__default.defineLocale("is", {
  ...
  const it = _moment__default.defineLocale("it", {
  ...
  const ja = _moment__default.defineLocale("ja", {
  ...
  const jv = _moment__default.defineLocale("jv", {
  ...
  const ka = _moment__default.defineLocale("ka", {
  ...
  const km = _moment__default.defineLocale("km", {
  ...
  const ko = _moment__default.defineLocale("ko", {
  ...
  function eifelerRegelAppliesToNumber(number) {
    ...
    if (number < 0) {
      ...
      // 2 digits
      let lastDigit = number % 10, firstDigit = number / 10;
      if (lastDigit === 0) {
  ...
  const lb = _moment__default.defineLocale("lb", {
  ...
  function relativeWeekDay(moment, format) {
    let nominative = format.indexOf("dddd HH:mm") === -1,
      weekDay = weekDays[moment.day()];
    return nominative ? weekDay : weekDay.substring(0, weekDay.length - 2) + "į";
  }

  const lt = _moment__default.defineLocale("lt", {
  ...
  const lv = _moment__default.defineLocale("lv", {
  ...
  const me__translator = {
    ...
    translate: function(number, withoutSuffix, key) {
      const wordKey = me__translator.words[key];
      if (key.length === 1) {
  ...
  const me = _moment__default.defineLocale("me", {
  ...
  const mk = _moment__default.defineLocale("mk", {
  ...
  const ml = _moment__default.defineLocale("ml", {
  ...
  const mr = _moment__default.defineLocale("mr", {
  ...
  const ms_my = _moment__default.defineLocale("ms-my", {
  ...
  const locale_ms = _moment__default.defineLocale("ms", {
    months : "Januari_Februari_Mac_April_Mei_Jun_Julai_Ogos_September_Oktober_November_Disember".split("_"),
    monthsShort : "Jan_Feb_Mac_Apr_Mei_Jun_Jul_Ogs_Sep_Okt_Nov_Dis".split("_"),
    weekdays : "Ahad_Isnin_Selasa_Rabu_Khamis_Jumaat_Sabtu".split("_"),
    weekdaysShort : "Ahd_Isn_Sel_Rab_Kha_Jum_Sab".split("_"),
  ...
  const my = _moment__default.defineLocale("my", {
  ...
  const nb = _moment__default.defineLocale("nb", {
  ...
  const ne = _moment__default.defineLocale("ne", {
  ...
  let nl__monthsShortWithDots = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
    nl__monthsShortWithoutDots = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_");

  const nl = _moment__default.defineLocale("nl", {
  ...
  const nn = _moment__default.defineLocale("nn", {
    months : "januar_februar_mars_april_mai_juni_juli_august_september_oktober_november_desember".split("_"),
    monthsShort : "jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"),
  ...
  const pl = _moment__default.defineLocale("pl", {
    months : function(momentToFormat, format) {
      if (format === "") {
  ...
  const pt_br = _moment__default.defineLocale("pt-br", {
  ...
  const pt = _moment__default.defineLocale("pt", {
    months : "Janeiro_Fevereiro_Março_Abril_Maio_Junho_Julho_Agosto_Setembro_Outubro_Novembro_Dezembro".split("_"),
    monthsShort : "Jan_Fev_Mar_Abr_Mai_Jun_Jul_Ago_Set_Out_Nov_Dez".split("_"),
    weekdays : "Domingo_Segunda-Feira_Terça-Feira_Quarta-Feira_Quinta-Feira_Sexta-Feira_Sábado".split("_"),
    weekdaysShort : "Dom_Seg_Ter_Qua_Qui_Sex_Sáb".split("_"),
  ...
  const ro = _moment__default.defineLocale("ro", {
  ...
  const ru = _moment__default.defineLocale("ru", {
  ...
  const si = _moment__default.defineLocale("si", {
  ...
  let sk__months = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_"),
  ...
  const sk = _moment__default.defineLocale("sk", {
    months : sk__months,
  ...
  const sl = _moment__default.defineLocale("sl", {
  ...
  const sq = _moment__default.defineLocale("sq", {
  ...
  const sr_cyrl__translator = {
    ...
    translate: function(number, withoutSuffix, key) {
      const wordKey = sr_cyrl__translator.words[key];
      if (key.length === 1) {
        return withoutSuffix ? wordKey[0] : wordKey[1];
      } else {
  ...
  const sr_cyrl = _moment__default.defineLocale("sr-cyrl", {
  ...
  const sr__translator = {
    ...
    translate: function(number, withoutSuffix, key) {
      const wordKey = sr__translator.words[key];
      if (key.length === 1) {
        return withoutSuffix ? wordKey[0] : wordKey[1];
      } else {
  ...
  const sr = _moment__default.defineLocale("sr", {
    months: ["januar", "februar", "mart", "april", "maj", "jun", "jul", "avgust", "septembar", "oktobar", "novembar", "decembar"],
    monthsShort: ["jan.", "feb.", "mar.", "apr.", "maj", "jun", "jul", "avg.", "sep.", "okt.", "nov.", "dec."],
  ...
  const sv = _moment__default.defineLocale("sv", {
  ...
  const ta = _moment__default.defineLocale("ta", {
  ...
  const th = _moment__default.defineLocale("th", {
  ...
  const tl_ph = _moment__default.defineLocale("tl-ph", {
  ...
  const tr = _moment__default.defineLocale("tr", {
  ...
  const tzl = _moment__default.defineLocale("tzl", {
  ...
  const tzm_latn = _moment__default.defineLocale("tzm-latn", {
  ...
  const tzm = _moment__default.defineLocale("tzm", {
  ...
  const uk = _moment__default.defineLocale("uk", {
  ...
  const uz = _moment__default.defineLocale("uz", {
  ...
  const vi = _moment__default.defineLocale("vi", {
  ...
  const zh_cn = _moment__default.defineLocale("zh-cn", {
  ...
  const zh_tw = _moment__default.defineLocale("zh-tw", {
    months : "一月_二月_三月_四月_五月_六月_七月_八月_九月_十月_十一月_十二月".split("_"),
    monthsShort : "1月_2月_3月_4月_5月_6月_7月_8月_9月_10月_11月_12月".split("_"),
    weekdays : "星期日_星期一_星期二_星期三_星期四_星期五_星期六".split("_"),
  ...
  const moment_with_locales = _moment__default;
